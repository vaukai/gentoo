...
# We still fail with:
# src/main/java/org/junit/jupiter/api/condition/EnabledOnJre.java:90: error: cannot find symbol
# 	JRE[] value();
# 	^
#   symbol:   class JRE
#   location: @interface EnabledOnJre
# src/main/java/org/junit/jupiter/api/condition/EnabledForJreRange.java:94: error: cannot find symbol
# 	JRE min() default JRE.JAVA_8;
# 	^
#   symbol:   class JRE
#   location: @interface EnabledForJreRange
# src/main/java/org/junit/jupiter/api/condition/EnabledForJreRange.java:106: error: cannot find symbol
# 	JRE max() default JRE.OTHER;
# 	^
#   symbol:   class JRE
#   location: @interface EnabledForJreRange
# src/main/java/org/junit/jupiter/api/condition/DisabledOnJre.java:90: error: cannot find symbol
# 	JRE[] value();
# 	^
#   symbol:   class JRE
#   location: @interface DisabledOnJre

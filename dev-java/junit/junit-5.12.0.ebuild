...
# We still fail, it seems to wamt _all_ modules of dev-java/open-test-reporting.
# src/main/java/org/junit/platform/reporting/open/xml/JUnitContributor.java:24: error: package org.opentest4j.reporting.tooling.spi.htmlreport does not exist
# import org.opentest4j.reporting.tooling.spi.htmlreport.Contributor;
#                                                       ^
# src/main/java/org/junit/platform/reporting/open/xml/JUnitContributor.java:25: error: package org.opentest4j.reporting.tooling.spi.htmlreport does not exist
# import org.opentest4j.reporting.tooling.spi.htmlreport.KeyValuePairs;
#                                                       ^
# src/main/java/org/junit/platform/reporting/open/xml/JUnitContributor.java:26: error: package org.opentest4j.reporting.tooling.spi.htmlreport does not exist
...
CP_DEPEND="
	...
	>=dev-java/open-test-reporting-events-0.2.0_pre1:0
	dev-java/picocli:0

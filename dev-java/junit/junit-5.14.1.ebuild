...
# presently not possible because JAVA_GENTOO_CLASSPATH_EXTRA does not go on -module-path
# hence it needs org.immutables.value packaged
# src/module/org.junit.platform.reporting/module-info.java:22: error: module not found: org.opentest4j.reporting.tooling.spi
...
S="${WORKDIR}/junit-framework-r${PV}"
...
CP_DEPEND="
	...
	>=dev-java/open-test-reporting-0.2.5:0
	dev-java/picocli:0

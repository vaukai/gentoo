...
DEPEND="
	>=virtual/jdk-11:*
	test? (
		>=dev-java/jackson-core-2.18.4:0
		>=dev-java/jackson-databind-2.18.4:0
		>=dev-java/jackson-dataformat-yaml-2.18.4:0
		dev-java/jmh-core:0
		>=dev-java/velocity-2.4.1:0
	)
"

# Only a newer version of testng could use us.
RDEPEND="
	!<dev-java/jackson-dataformat-yaml-2.18.4:0
	!<dev-java/testng-7.8.0:0
	>=virtual/jre-1.8:*
"

...
MY_COMMIT="8e3e9dce8b542074cf2a9749a7cb483bbc401e87"
SRC_URI="https://github.com/javaparser/javaparser/archive/${MY_COMMIT}.tar.gz -> javaparser-${PV}.tar.gz"
S="${WORKDIR}/javaparser-${MY_COMMIT}"

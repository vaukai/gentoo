...
MAVEN_ID="com.squareup:javapoet:1.13.0"
...
SRC_URI="https://github.com/square/${PN}/archive/${P}.tar.gz
	test? (
		...
		https://repo1.maven.org/maven2/com/google/testing/compile/compile-testing/0.15/compile-testing-0.15.jar
	)"
S="${WORKDIR}/${PN}-${P}"
...
PATCHES=( "${FILESDIR}/javapoet-1.13.0-skip_overrideGenerics.patch" )
...
src_test() {
	JAVA_GENTOO_CLASSPATH_EXTRA="${DISTDIR}/compile-testing-0.15.jar"
	JAVA_GENTOO_CLASSPATH_EXTRA+=":${DISTDIR}/truth-0.39.jar"

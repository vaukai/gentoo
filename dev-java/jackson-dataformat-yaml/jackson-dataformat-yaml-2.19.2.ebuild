...
MAVEN_ID="com.fasterxml.jackson.dataformat:jackson-dataformat-yaml:2.18.4"
...
# needs at least jdk-23
# java.lang.UnsupportedClassVersionError: ch/randelshofer/fastdoubleparser/JavaBigDecimalParser
# has been compiled by a more recent version of the Java Runtime (class file version 67.0),
...
JAVA_TEST_GENTOO_CLASSPATH="fastdoubleparser junit-4"
...
src_prepare() {
	...
	# 'mvn clean test' does not seem to run anything from the 'failing' directory.
	rm -r src/test/java/com/fasterxml/jackson/dataformat/yaml/failing || die
}

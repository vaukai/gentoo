...
JPV="1.9.1"	# junit-pioneer isn't presently packaged
EV="5.6.0"	# dev-java/easymock needs an update
SRC_URI="https://archive.apache.org/dist/commons/lang/source/${PN}3-${PV}-src.tar.gz -> ${P}-src.tar.gz
	test? (
		https://repo1.maven.org/maven2/org/junit-pioneer/junit-pioneer/${JPV}/junit-pioneer-${JPV}.jar
		https://repo1.maven.org/maven2/org/easymock/easymock/${EV}/easymock-${EV}.jar
	)
...
PATCHES=( "${FILESDIR}/commons-lang-3.18.0-skipFailingTests.patch" )

JAVA_AUTOMATIC_MODULE_NAME="org.apache.commons.lang3"
JAVA_GENTOO_CLASSPATH_EXTRA="org.apache.commons.lang3.jar"
JAVA_GENTOO_CLASSPATH_EXTRA+=:"${DISTDIR}/junit-pioneer-${JPV}.jar":"${DISTDIR}/easymock-${EV}.jar"
JAVA_INTERMEDIATE_JAR_NAME="org.apache.${PN/-/.}3"
JAVA_MODULE_INFO_OUT="src/main"
JAVA_SRC_DIR="src/main/java"
JAVA_TEST_GENTOO_CLASSPATH="asm commons-text jmh-core junit-5 jsr305 opentest4j"

...
MAVEN_ID="com.google.protobuf:protobuf-java:${PV}-RC1"
...
# And we build artifact 4.30.0 from the 30.0 tarball in order to allow sharing the tarball with
# dev-libs/protobuf.
MY_PV4="${PV#4.}"
MY_PV="${MY_PV4/_rc/-rc}"
...
src_test() {
	...
	# package com.google.testing.junit.testparameterinjector does not exist
	rm -v java/core/src/test/java/com/google/protobuf/CodedInputStreamTest.java || die "remove certain test"

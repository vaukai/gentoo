...
BDEPEND="
	...
	!system-protoc? ( >=dev-cpp/abseil-cpp-20250127.0:= )
"
...
src_prepare() {
	...
	rm java/core/src/test/java/com/google/protobuf/LargeEnumLiteTest.java || die
	rm java/core/src/test/java/com/google/protobuf/LargeEnumTest.java || die
}

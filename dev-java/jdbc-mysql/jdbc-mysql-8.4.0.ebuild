...
MAVEN_ID="com.mysql:mysql-connector-j:8.4.0"
...
# error: package io.opentelemetry.api does not exist
# error: package io.opentelemetry.api.trace does not exist
# error: package io.opentelemetry.context does not exist

# and it still wants the old protobuf
CP_DEPEND="
	dev-java/c3p0:0

...
JAVA_GENTOO_CLASSPATH_EXTRA+=:"${DISTDIR}/junit-pioneer-${JPV}.jar:${DISTDIR}/aircompressor-${AAV}.jar"
...
JAVA_TEST_GENTOO_CLASSPATH="javax-inject junit-4 junit-5 memoryfilesystem mockito-4 opentest4j"

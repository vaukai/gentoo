...
SRC_URI="https://downloads.apache.org/poi/release/src/apache-poi-src-${PV}-${RELEASE_DATE}.tgz
	verify-sig? ( https://downloads.apache.org/poi/release/src/apache-poi-src-${PV}-${RELEASE_DATE}.tgz.asc )"

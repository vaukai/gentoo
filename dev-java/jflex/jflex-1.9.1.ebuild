...
SRC_URI="https://github.com/jflex-de/jflex/releases/download/v${PV}/${P}.tar.gz
	test? (
		https://repo1.maven.org/maven2/com/pholser/junit-quickcheck-generators/1.0/junit-quickcheck-generators-1.0.jar
		https://repo1.maven.org/maven2/com/pholser/junit-quickcheck-core/1.0/junit-quickcheck-core-1.0.jar
...
JAVA_TEST_GENTOO_CLASSPATH="ant antlr-runtime-3.5 generics-resolver guava javaruntype junit-4 slf4j-simple truth"
...
src_test() {
	# Some test dependencies still to be packaged:
	JAVA_GENTOO_CLASSPATH_EXTRA+=":${DISTDIR}/junit-quickcheck-core-1.0.jar"
	JAVA_GENTOO_CLASSPATH_EXTRA+=":${DISTDIR}/junit-quickcheck-generators-1.0.jar"
	JAVA_GENTOO_CLASSPATH_EXTRA+=":${DISTDIR}/ognl-3.1.12.jar"
